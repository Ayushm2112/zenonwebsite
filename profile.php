    ...
    <div class="topnav">
        ...
        <div class="mid">
            <ul class="navbar">
                ...
                <a href="placeuser.html">Placement</a>
            </ul>
        </div>
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                ...
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold"><?php /*session_start();*/ if(isset($_SESSION['email'])){ echo $_SESSION['email'] ; } ?></span>
                </div>
              </div>
            </a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello <?php /*session_start();*/ if(isset($_SESSION['email'])){ echo $_SESSION['email'] ; } ?> </h1>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                <?php /*session_start();*/ if(isset($_SESSION['email'])){ echo $_SESSION['email'] ; } ?><span class="font-weight-light">, 27</span>
                </h3>
